  ...
  return (
    <div className="pb-20 pt-36 h-screen">
      ...
      <div className="max-W-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <h2 className="uppercase tracking-widest text-ws text-center text-blue-100 max-w-80 ">
            Dynamic Web Design With Yohan
          </h2>
          <TextGenerateEffect
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
            words="This is a test build"
          />
          <p className="text-center text-[40px] md:text-5xl lg:text-6xl">
            Hi I&apos;m Yohan a next js dev based in Sri Lanka 
          </p>
          <a href="#about">
            <MagicButton
             title="show my work"
